  ...
  >
    <View className="flex flex-col items-center justify-center p-3">
      <Image
        ...
        source={{
          uri: `https://maps.geoapify.com/v1/staticmap?style=osm-bright-smooth&
          width=600&height=400&center=lonlat:${destination_longitude},
          ${destination_latitude}&zoom=14&apiKey=${process.env.GEOAPIFY_API_KEY}`,
        }}
      />
